# ResNet-34 with CIFAR-10 Classifier

A modular deep learning project implementing ResNet-34 architecture to classify the CIFAR-10 dataset. Since CIFAR-10 dataset is 32x32, we add resize it to 128. This project is device agnostic and optimised for systems with multiple GPUs and managed with the `uv` package manager.
...
## 📜 License
This project is licensed under the MIT License - see the LICENSE file for details.# ResNet-34 CIFAR-10 Classifier
...
## 📜 License
This project is licensed under the MIT License - see the LICENSE file for details. Note on Multi-GPU:
If you move this project from your MacBook M3 to a multi-GPU server (e.g., a Linux machine with 4x RTX 4090s), the script will automatically detect all available CUDA devices and distribute the batch across them.
